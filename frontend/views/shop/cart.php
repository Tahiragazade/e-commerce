	...
	<div class="row px-xl-5">
		<div class="col-lg-8 table-responsive mb-5">
			<table class="table table-light table-borderless table-hover text-center mb-0">
				...
				<tr>
					<td class="align-middle"><img src="img/product-1.jpg" alt="" style="width: 50px;"> <?=$product->product->title?></td>
					<td class="align-middle"><?=$product->color->name?></td>
					<td class="align-middle"><?=$product->size->name?></td>
...
<!--					<button class="btn btn-block btn-primary font-weight-bold my-3 py-3">Proceed To Checkout</button>-->
					<?= Html::a('Proceed To Checkout', ['cart/checkout'], ['class' => 'btn btn-block btn-primary font-weight-bold my-3 py-3']) ?>
				</div>
			</div>
		</div>
	</div>
